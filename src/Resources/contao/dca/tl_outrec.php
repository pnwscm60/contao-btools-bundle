...
(
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_outrec']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_outrec']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			/*'toggle' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_outrec']['toggle'],
				'icon'                => 'visible.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_outrec']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif',
	...
	(
		...
		'datum' => array
		(
			'label'			=> &$GLOBALS['TL_LANG']['tl_outrec']['datum'],
			'exclude'                 => true,
			'inputType'               => 'text',
        	...
        	'grund' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_outrec']['grund'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'amount' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_outrec']['amount'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'descript' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_outrec']['descript'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
