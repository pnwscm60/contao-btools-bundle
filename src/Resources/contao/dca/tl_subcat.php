 ...
 * Table tl_subcat
 */
$GLOBALS['TL_DCA']['tl_subcat'] = array
(
	// Config
	'config' => array
	(
	...
	(
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_subcat']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_subcat']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_subcat']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif',
    ...
    'catid'     => array
		...
		'description' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_category']['description'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
